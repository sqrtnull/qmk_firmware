...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUM] = LAYOUT_split_3x5_3(
      ...
      XXXXXXX, OS_LGUI, OS_LALT, MO(FUN), XXXXXXX,                      XXXXXXX,    KC_4,    KC_5,    KC_6,    KC_0,
    ...
    [NAV] = LAYOUT_split_3x5_3(
       KC_ESC, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U,                      KC_HOME, KC_PGUP, TG(NAV), TG(NAV), TG(NAV),
      TG(NAV), KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D,                      KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, TG(NAV),
      KC_WH_L, KC_BTN4, KC_BTN3, KC_BTN5, KC_WH_R,                       KC_END, KC_PGDN, KC_BSPC,  KC_TAB, XXXXXXX,
                                 XXXXXXX, XXXXXXX, _______,    _______, _______, KC_LALT
  ),
