...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x5_3(
         ...
         KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,
                                   KC_LGUI, MO(2), OS_LSFT,    OS_LCTL,  KC_SPC, MO(1)

  ),

    [1] = LAYOUT_split_3x5_3(
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                      XXXXXXX,    KC_7,    KC_8,    KC_9, XXXXXXX,
      XXXXXXX, XXXXXXX, XXXXXXX,   MO(4), XXXXXXX,                      XXXXXXX,    KC_4,    KC_5,    KC_6,    KC_0,
    ...
    [3] = LAYOUT_split_3x5_3(
       KC_ESC, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U,                      XXXXXXX, KC_PGUP, KC_HOME, KC_SCLN, XXXXXXX,
      ...
      KC_WH_L, KC_BTN4, KC_BTN3, KC_BTN5, KC_WH_R,                      XXXXXXX, KC_PGDN,  KC_END, KC_BSPC, XXXXXXX,
                                 _______, XXXXXXX, _______,    _______, _______, KC_LALT
  ),
