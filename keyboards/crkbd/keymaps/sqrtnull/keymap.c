...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                      KC_LGUI,OSL(2),OSM(MOD_LSFT),     OSM(MOD_LCTL),KC_SPC,KC_LALT
                                      //`--------------------------'  `--------------------------'
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______, _______, _______, _______, _______, _______,                      _______,    KC_4,    KC_5,    KC_6,  KC_SPC, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
...
void leader_end_user(void) {
    if (leader_sequence_one_key(KC_J)) {
        SEND_STRING(SS_LCTL(SS_LSFT(SS_LALT(SS_TAP(X_J))))); // MEH J
    } else if (leader_sequence_one_key(KC_K)) {
        SEND_STRING(SS_LCTL(SS_LSFT(SS_LALT(SS_TAP(X_K))))); // MEH K
    }
}
